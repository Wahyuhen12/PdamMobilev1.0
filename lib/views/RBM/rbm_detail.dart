...
class RbmDetail extends StatefulWidget {
  const RbmDetail({Key key}) : super(key: key);
...
class _RbmDetailState extends State<RbmDetail> {
  ...
  List<NamaPelanggan> sudahbaca = [
    NamaPelanggan(
        idpel: 1, nama: "Poernomo", status: true, tagihan: "A2.2/999DEMO"),
    NamaPelanggan(
        idpel: 3, nama: "Johan", status: true, tagihan: "A4.2/999DEMO"),
    NamaPelanggan(
        idpel: 5, nama: "Wahyu", status: true, tagihan: "A6.2/999DEMO"),
  ];

  List<NamaPelanggan> belumbaca = [
    NamaPelanggan(
        idpel: 2, nama: "Susanto", status: false, tagihan: "A3.2/999DEMO"),
    NamaPelanggan(
        idpel: 4, nama: "Anton", status: false, tagihan: "A5.2/999DEMO"),
    NamaPelanggan(
        idpel: 6, nama: "Stark", status: false, tagihan: "A7.2/999DEMO"),
    NamaPelanggan(
        idpel: 7, nama: "Jonny", status: false, tagihan: "A8.2/999DEMO"),
  ];
